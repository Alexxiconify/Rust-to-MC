            ...
            return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                    ...
                    .option(Option.<Boolean>createBuilder()
                        ...
                        .build())
                    .option(Option.<Boolean>createBuilder()
                        .name(Text.literal("Fast Inv-Sqrt"))
                        .description(OptionDescription.of(Text.literal(
                        ...
                        .build())
                    .option(Option.<Boolean>createBuilder()
                        .name(Text.literal("Native Tan"))
                        .binding(true, cfg::isUseNativeTan, v -> cfg.setUseNativeTan(v != null && v))
                        .controller(BooleanControllerBuilder::create)
                        .build())
                    .option(Option.<Boolean>createBuilder()
                        .name(Text.literal("Native Atan2"))
                        .binding(true, cfg::isUseNativeAtan2, v -> cfg.setUseNativeAtan2(v != null && v))
                        .controller(BooleanControllerBuilder::create)
                        .build())
                    .option(Option.<Boolean>createBuilder()
                        .name(Text.literal("Native Floor"))
                        .binding(true, cfg::isUseNativeFloor, v -> cfg.setUseNativeFloor(v != null && v))
                        .controller(BooleanControllerBuilder::create)
                        .build())
                    .option(Option.<Boolean>createBuilder()
